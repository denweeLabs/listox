...
mixin _$GroceryCategory {
 ...
 UniqueId get id; String get name;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GroceryCategory&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( UniqueId id,  String name)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GroceryCategory() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( UniqueId id,  String name)  $default,) {final _that = this;
switch (_that) {
case _GroceryCategory():
return $default(_that.id,_that.name);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( UniqueId id,  String name)?  $default,) {final _that = this;
switch (_that) {
case _GroceryCategory() when $default != null:
return $default(_that.id,_that.name);case _:
  return null;
...
class _GroceryCategory implements GroceryCategory {
  const _GroceryCategory({required this.id, required this.name});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GroceryCategory&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name));
}
