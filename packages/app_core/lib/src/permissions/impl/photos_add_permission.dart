...
class AppPhotosAddPermission extends AppPermission {
  ...
  Future<AppPermissionStatus> request() async {
    ...
    return (await Permission.photosAddOnly.request()).toDomain();
  }
  ...
  Future<AppPermissionStatus> status() async {
    ...
    return (await Permission.photosAddOnly.status).toDomain();
  }
}
